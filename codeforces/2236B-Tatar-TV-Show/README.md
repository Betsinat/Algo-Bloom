...
For example, if s = 10110 and k = 2, then by choosing i = 2, Arseniy inverts the characters at positions 2 and 4: [ 10110 → 11100 ]
...
The first line of each test case contains two integers n and k (1 ≤ k ≤ n ≤ 2 ⋅ 10⁵).
